    ...
    <nav class="navbar navbar-expand-sm">
        <div class="container">
            <ul class="navbar-nav">
                ...
                <li class="nav-item"><a href="#explore-head-section" class="nav-link">Collection</a></li>
            </ul>
            ...
            <div class="collapse navbar-collapse" id="meny">
                <ul class="navbar-nav">
                    <li class="nav-item"><a href="#home-section" class="nav-link">Promo</a></li>
                    <li class="nav-item"><a href="#explore-head-section" class="nav-link">About</a></li>
                </ul>
            </div>
    ...
    <footer class="container-fluid">
        <div class="row text-white text-center">
            <div class="col-3 mt-5">
                ...
                <p>Showroom</p>
                <br>
                <p>Palma Furniture, Rr.Bujanocit, kilometri i pare 60000 Gjilan, Kosove</p>
                <p>palmamobile@hotmail.com <br> +383 44 240 082</p>
            </div>
            <div class="col-3 mt-5">
                <h1>Prizren</h1>
                <p>Showroom</p>
                <br>
                <p>Magjistralja Prizren-Suahreke, kilometri i pare Prizren, Kosove</p>
                <p>palmamobile@hotmail.com <br> +383 44 240 082</p>
            </div>
            <div class="col-3 mt-5">
                <h1>Ferizaj</h1>
                <p>Showroom</p>
                <br>
                <p>Palma Furniture, Te rrethi Ferizaj, Kosove</p>
                <p>palmamobile@hotmail.com <br> +383 44 240 082</p>
            </div>
            <div class="col-3 mt-5">
                <h1>Fabrika</h1>
